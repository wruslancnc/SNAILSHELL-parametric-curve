...
char CurveTypeDesc[80] = "SNAILSHELL ALGO=20 SKIP-STEP2 RUN-STEP1 RUN-ADJFRATE FRATECMD=10";
...
// START BYPASS ADJUST FRATE PART 1/2 <<<<<<<<<<<<<<<<<<<
              // INCREASE curr_frate
...
// END BYPASS ADJUST FRATE PART 1/2 <<<<<<<<<<<<<<<<<<<< 
...
// START BYPASS ADJUST FRATE PART 2/2 <<<<<<<<<<<<<<<<<
...
// END BYPASS ADJUST FRATE PART 2/2 <<<<<<<<<<<<<<<<<<<
...
// START BYPASS STEP 1 <<<<<<<<<<<<<<
      ...
      if (curr_eps > uppertol_bound)
        ...
        }  // PLACE END BRACES FOR STEP 1 / REMOVE FOR STEP 2 
